...
// 二进制表达式
// 1+2
// 1+2+3 这种属于 BinaryExpression 嵌套，1+2会变成一个新的 BinaryExpression，然后再作为父 BinaryExpression 的 left 节点参与运算
...
// 指令
// "use strict" 里面会包含 DirectiveLiteral
...
// new
// callee 是 class 构造函数, arguments 是构造函数入参
