    ...
    describe("node auto-require", () => {
      it("works with the -r flag", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4546) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          (node:4546) ExperimentalWarning: CommonJS module /home/runner/work/babel/babel/packages/babel-core/lib/config/files/module-types.js is loading ES Module /home/runner/work/babel/babel/packages/babel-plugin-transform-modules-commonjs/lib/index.js using require().
      ...
      it("works with the --require flag", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4558) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          (node:4558) ExperimentalWarning: CommonJS module /home/runner/work/babel/babel/packages/babel-core/lib/config/files/module-types.js is loading ES Module /home/runner/work/babel/babel/packages/babel-plugin-transform-modules-commonjs/lib/index.js using require().
          Support for loading ES Module in require() is an experimental feature and might change at any time
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
      ...
      it("works with the -r flag in NODE_OPTIONS", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4572) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          (node:4572) ExperimentalWarning: CommonJS module /home/runner/work/babel/babel/packages/babel-core/lib/config/files/module-types.js is loading ES Module /home/runner/work/babel/babel/packages/babel-plugin-transform-modules-commonjs/lib/index.js using require().
          Support for loading ES Module in require() is an experimental feature and might change at any time
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
      ...
      it("works with the --require flag in NODE_OPTIONS", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4584) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          (node:4584) ExperimentalWarning: CommonJS module /home/runner/work/babel/babel/packages/babel-core/lib/config/files/module-types.js is loading ES Module /home/runner/work/babel/babel/packages/babel-plugin-transform-modules-commonjs/lib/index.js using require().
          Support for loading ES Module in require() is an experimental feature and might change at any time
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
